...
if ( ! function_exists( 'cdn_adventure_setup' ) ) :
/**
 * Sets up theme defaults and registers support for various WordPress features.
 */
function cdn_adventure_setup() {
...
endif; // cdn_adventure_setup
add_action( 'after_setup_theme', 'cdn_adventure_setup' );
 ...
 */
function cdn_adventure_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'cdn_adventure_content_width', 640 );
}
add_action( 'after_setup_theme', 'cdn_adventure_content_width', 0 );
 ...
 */
function cdn_adventure_widgets_init() {
...
add_action( 'widgets_init', 'cdn_adventure_widgets_init' );

/**
 * Filter the stylesheet_uri to output the minified CSS file.
 */
function cdn_adventure_minified_css( $stylesheet_uri, $stylesheet_dir_uri ) {
...
add_filter( 'stylesheet_uri', 'cdn_adventure_minified_css', 10, 2 );

/**
 * Enqueue scripts and styles.
 */
function cdn_adventure_scripts() {
	wp_enqueue_style( 'red-starter-style', get_stylesheet_uri() );
	wp_enqueue_style( 'bxslider_stylesheet', get_template_directory_uri() . '/js/jquery.bxslider/jquery.bxslider.css');
